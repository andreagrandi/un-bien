...
| [App Store release checklist (GitHub)](https://github.com/georgeharker/un-bien/blob/main/APPSTORE.md)        | The submission checklist — screenshots, review notes, signing. (Not rendered on the docs site.) |
